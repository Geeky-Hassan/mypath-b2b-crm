...
CSV export, team operations, Lead Generator administration, and permanent
deletion. Lead Generators create/enrich/import leads, record activities, complete
...
The board uses pointer and keyboard drag sensors. Each column shows its lead count and proposed-value total. Filters cover owner, segment, source, country, and date-added range. A card opens a lead drawer with current facts, notes, recent activities, and stage history.
...
archive/restore, founder deletion, activities, notes, and stage history.
