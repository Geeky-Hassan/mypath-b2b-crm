...
- A production Supabase project with all ten migrations, `team-admin` deployed, and the initial Founder verified.
...
1. Apply all migrations through `202608040010_safe_team_member_removal.sql` and deploy `team-admin` with JWT verification enabled.
